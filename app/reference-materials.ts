...
export function referenceMaterials(){
 const originals=new Map<THREE.Mesh,THREE.Material|THREE.Material[]>(),cache=new Map<THREE.Material,{grey:THREE.Material;depth:THREE.Material}>();
 ...
 function replacement(original:THREE.Material,mode:'grey'|'depth'){
