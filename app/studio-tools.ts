...
export function useStudioTools(setSettings:Dispatch<SetStateAction<Settings>>){
 useEffect(()=>{
  ...
  const ranges:Record<string,number[]>={speed:[.25,2],phase:[0,1],fov:[15,150],ambient:[0,4],exposure:[.4,2.5]};
