...
export const defaults:Settings={gait:'idle',motionEnabled:true,playing:true,speed:1,phase:0,rotate:true,grid:true,darkMode:true,fov:36,coat:'Pinto',...lightingPreset('Soft studio'),lightHelpers:false,reference:'textured',poseMode:false,poseTool:'rotate',poseSpace:'local',poseSnap:false,showJoints:true};
